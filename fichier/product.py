    ...
    def draw_rectangles(self, x_param):
        ...
        if nb:
            ...
            for i in range(nb):
                ...
                self.change_p_rect = pygame.draw.rect(self.screen, self.black, (x_param + i * (self.rect_width + 200)+50, 400, 120, 40),2)
                ...
                self.change_q_rect = pygame.draw.rect(self.screen, self.black, (x_param + i * (self.rect_width + 200)+220, 400, 120, 40),2)
